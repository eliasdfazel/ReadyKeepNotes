...
import net.geeksempire.ready.keep.notes.Utils.UI.Views.FluidSlide.FluidSlider.Size.NORMAL
import net.geeksempire.ready.keep.notes.Utils.UI.Views.FluidSlide.FluidSlider.Size.SMALL
import kotlin.math.*
...
class FluidSlider @JvmOverloads constructor(
    ...
    override fun onSaveInstanceState(): Parcelable {
        return State(super.onSaveInstanceState()!!, position, startText, endText, textSize, colorBubble, colorBar, colorBarText, colorBubbleText, duration)
    }
