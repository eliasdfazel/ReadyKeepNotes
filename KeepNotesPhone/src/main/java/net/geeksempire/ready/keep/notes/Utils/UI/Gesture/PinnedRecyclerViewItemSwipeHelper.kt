...
abstract class PinnedRecyclerViewItemSwipeHelper(private val context: KeepNoteOverview, private val swipeActions: SwipeActions) : ItemTouchHelper.SimpleCallback(
    ItemTouchHelper.UP
...
private fun List<PinnedRecyclerViewItemSwipeHelper.UnderlayButton>.intrinsicWidth(): Float {
